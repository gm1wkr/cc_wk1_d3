...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_reverse_string(self):
    reversed_string = reverse_string("CodeClan Rules!")
    self.assertEqual("!seluR nalCedoC", reversed_string)
  ...
  def test_fahrenheit_to_celsius_2(self):
    celsius_2 = fahrenheit_to_celsius(80)
    self.assertEqual(27, celsius_2)
